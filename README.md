...
This plugin uses my c-shellcode converter to HEX (handy tool for paste & execute shellcodes in gdb, windbg, radare2, ollydbg, x64dbg, immunity debugger & 010 editor):
